      ...
      <div className="flex flex-col md:flex-row  justify-between px-6 md:px-16 py-12  text-white relative z-20">
        ...
        <div className="md:w-1/2 space-y-6 ">
          ...
          <p className="text-base">
            A beginner-friendly program designed to teach you the <br className='hidden md:inline' /> fundamentals of artificial intelligence and software <br className='hidden md:inline' /> development through practical, project-based learning.
          </p>
